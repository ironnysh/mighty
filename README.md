...
- [Getting started](https://github.com/ironnysh/TalRimon#getting-started)
- [Customize](https://github.com/ironnysh/TalRimon#customize-and-adapt-the-content-and-design)
- [Tips](https://github.com/ironnysh/TalRimon#tips)
- [Epilogue](https://github.com/ironnysh/TalRimon#epilogue)
- [Contributions](https://github.com/ironnysh/TalRimon#contributions)
- [Directory structure](https://github.com/ironnysh/TalRimon#directory-structure)
- [File overview](https://github.com/ironnysh/TalRimon#file-overview)
...
```
git clone --depth=1 https://github.com/ironnysh/TalRimon.git your-project-name
...
[![Deploy to Vercel](https://vercel.com/button)](https://vercel.com/new/clone?repository-url=https://github.com/ironnysh/TalRimon.git)

## Customize and adapt the content and design

###  Change the content
There are three files to edit (see the [File overview](https://github.com/ironnysh/TalRimon#file-overview) below for details):
...
2. There are three fonts in use (see the [File overview](https://github.com/ironnysh/TalRimon#file-overview) below). If you delete or replace any of them, update the references in two places: the `@font-face` rules at the top and the `font-family` variable. There are fallback system fonts for each.
