...
Mighty is using [Eleventy (11ty)](https://www.11ty.dev) to build a one-pager or landing page - a simple, elegant theme from which freelancers or small businesses can generate simple one-pagers.
